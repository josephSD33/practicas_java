...
public class VentanaAhorcadoA extends javax.swing.JFrame {
    ...
    private String eligePalabra(){
        String [] listaPalabras = {"FRAMEWORK" , "JAVASWING", "FRONTEND", "BACKEND", "HERENCIA","Polimorfismo","Github"};
    ...
    private void chequeaLetra (String letra){
        ...
        if(palabraOculta.contains(letra)){
            ...
            JOptionPane.showMessageDialog(rootPane, "¡Has acertado la palabra!");
            }
        }
        else{
        numeroFallos++;
        if(numeroFallos == 6){
            JOptionPane.showMessageDialog(rootPane, "final");
            partidaTerminada = true;
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        String mensajeJuego = """
                    El siguiente juego es el ahorcado. Tienes seis intentos para adivinar la palabra. 
                    Si superas los seis intentos, pierdes. Después de ganar o perder, pulsa siguiente para continuar.
                    """;
                JOptionPane.showMessageDialog(null, mensajeJuego, "Instrucciones del Juego", JOptionPane.INFORMATION_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaAhorcadoA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaAhorcadoA().setVisible(true);
            }
        });
    }
